    ...
    const sendPrompt = () => {
        ...
        fetch(`${process.env.REACT_APP_API_URL}/openai/prompt`,
            ...
            .then(responseData => {
                ...
                setData(newData);
                formatPromptConversation(newData);
            });
    };
        ...
        setResponseItems(promptData.map(item =>
            <>
                <div className="row py-3" style={{whiteSpace: "pre-wrap"}}>
                    <div className={"col-1"}>
                        <img src={user.picture} alt={user.name} className="rounded-circle" width="40" height="40"/>
                    </div>
                    <div className="col">
                        {item.prompt}
                    </div>
                </div>
                <div className="row bg-light py-3" style={{whiteSpace: "pre-wrap"}}>
                    <div className={"col-1"}>
                        <svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg"
                             stroke-width="1.5" className="h-6 w-6" role="img"><title>ChatGPT</title>
